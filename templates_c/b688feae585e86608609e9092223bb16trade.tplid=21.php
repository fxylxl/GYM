...
<div class="main">
    ...
    <div id="trade">
    	<form method="post" action="order.php" >
        	...
        	<div class="picture"><img src="<?php echo $this->vars['thumbnail']; ?>" alt="{goods_name}" /></div>
        	<div class="details">
        		<div class="goods_name"><?php echo $this->vars['goods_name']; ?></div>
        		<div class="price">价格:　    　<span>￥<?php echo $this->vars['price']; ?>.00</span></div>
        		<div class="freight">运费:　　　<?php echo $this->vars['freight']; ?>.00元</div>
        		...
        		<p>
        			<a href="pay.php?id=<?php echo $this->vars['id']; ?>">结算</a>
        		</p>  	
    		</form> 	
